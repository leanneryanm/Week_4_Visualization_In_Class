...
+ and anything after adds layers to plot
...
```{r}
ggplot(data = mpg) +
  geom_histogram(mapping = aes(x = hwy), binwidth = 2, fill="light blue")
```

?geom_histogram in console + ENTER for arugments 
...
```{r}
ggplot(data = mpg) +
  geom_point(mapping = aes(x = displ, y = hwy, color = class), alpha=0.2)
```
